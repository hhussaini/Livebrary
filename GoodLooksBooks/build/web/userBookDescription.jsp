...
<!--            <h5 id="bookTitleID">Book Title:  Andersonville: A Story of Rebel Military Prisons</h5>
                <br> <h5 id="bookAuthorID">Book Author: McElroy, John, 1846-1929</h5>
                <br> <h5 id="bookDescriptionID">Book Description: </h5>
                <br> <h5 id="dateCreatedID">Date Created: 6-1-2004</h5>
                <br> <h5 id="copiesAvailableID">Copies Available: 472</h5>
                <br> <h5 id="availableFormatsID">Available Formats: Kindle</h5>
                <br> <h5 id="languageID">Language: en</h5>
                <br> <h5>Subjects: "Military prisons", "United States -- History -- Civil War, 1861-1865 -- Prisoners and prisons", "Andersonville Prison", "Confederate States of America. Army -- Prisons" </h5>
     -->
          </form>  
        </div>
