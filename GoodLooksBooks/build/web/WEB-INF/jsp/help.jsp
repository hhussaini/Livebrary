...
<head>
 <title>Get Help With Good Looks Books</title>
 <meta charset="utf-8">
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav" style="font-weight: bold;">
    ...
    <li class="active"><a href="help.jsp">Help<span class="sr-only">(current)</span></a></li>
   </ul>
  ...
  <div class="container">
      <div class="panel panel-default">
          <div class="panel-heading">
              <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i>Help Options</h3>
          </div>
          <div class="panel-body">
              <div class="list-group">
                  <a href="support.jsp"><img alt="brand" width = "100" height = "100" src="assets/support-icon.jpg"></a>
                  Support
              </div>
          </div>
      </div>
