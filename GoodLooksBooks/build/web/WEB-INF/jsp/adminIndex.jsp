  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        <a href="adminIndex.jsp" class="pull-left">
          <img alt="brand" src="assets/brand-icon.png"></a>
        </div>
        <ul class="nav navbar-nav" style="font-weight: bold;">
          <li class="active"><a href="adminIndex.jsp">Admin Home</a></li>
    ...
    <div class="container">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="list-group">
            <a href="#"><img alt="brand" width = "100" height = "100" src="assets/employees-icon.png"></a>
            View Employee Data
          </div>
          <div class="list-group">
            <a href="#"><img alt="brand" width = "100" height = "100" src="assets/customer-service-icon.jpg"></a>
