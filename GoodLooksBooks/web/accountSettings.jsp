            ...
            <div class="container">
                <div class="panel panel-default">
                    ...
                    <form name = "accountSettingsForm" action = "UpdateUserServlet" method = "post">
                        ...
                        <div class = "controls regControl">
                            <select name="state" class="form-control" name="state" d="state">
                        ...
                        <div class = "controls regControl">
                            <input type="text" class="form-control input-medium bfh-phone" data-country="US" name="phoneNumber" id="phoneNumber" value="${user.phoneNumber}">
                        </div>
