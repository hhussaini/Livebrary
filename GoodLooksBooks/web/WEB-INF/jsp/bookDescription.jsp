 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav" style="font-weight: bold;">
    ...
    <li class="active"><a href="fullCatalog.jsp">Full Catalog<span class="sr-only">(current)</span></a></li>
 ...
 <div class="glb-page">
  ...
  <div class="bookDescription container">
   ...
   <div class="col-xs-6 col-sm-7" style="border-style: groove;">
    <h5>Book Title:  Andersonville: A Story of Rebel Military Prisons</h5>
    <br> <h5>Book Author: McElroy, John, 1846-1929</h5>
    <br> <h5>Book Description: </h5>
    <br> <h5>Date Created: 6-1-2004</h5>
    <br> <h5>Downloads: 472</h5>
    <br> <h5>Language: en</h5>
