        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="list-group">
                    <a href="#"><img alt="brand" width = "100" height = "100" src="assets/edit-books-icon.jpg"></a>
                    View/Edit Item Data
                </div>
                <div class="list-group">
                    <a href="#"><img alt="brand" width = "100" height = "100" src="assets/book-icon.jpg"></a>
                    Request Item Addition
                </div>
            </div>
        </div>
    </div>
