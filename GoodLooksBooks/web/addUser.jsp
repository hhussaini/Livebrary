           ...
           <div class="container">
               <div class="panel panel-default">
                   <div class="panel-heading">
                       <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i>Add New User</h3>
                   </div>
                   <form name = "adminAccountSettingsForm" action = "AdminAccountManagementServlet" method = "submitAdd">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         <label class = "control-label regLabel" for="userType">User Type:</label>
                         <div class = "controls regControl">
                        ...
                        <div class="form-group">
                           <label class = "control-label regLabel" for="company">Company:</label>
                           <div class = "controls regControl">
                               <input type="text" class="form-control" name="company">
                           </div>
                        </div>
                       <input type="hidden" name="method" value="submitAdd">
